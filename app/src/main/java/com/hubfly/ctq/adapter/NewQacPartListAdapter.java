 ...
 */
public class NewQacPartListAdapter extends BaseAdapter {
    //View Elements
    LayoutInflater inf;
    Context context;
    ArrayList<PartJobCodeModel> resultArray = new ArrayList<PartJobCodeModel>();


    public NewQacPartListAdapter(Context context, ArrayList<PartJobCodeModel> dateList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ho.name.setText(resultArray.get(position).getPartJobCodeHF());
